        ...
        <div class="cinema-swiper">
            ...
            <!-- slides -->
                <swiper-slide v-for="item in movies" :key='item.id' class="swiper-item">
                   <div class="img-box">
                       <img width="65" height="95" :src= "item.img | replaceWH(148,208)" alt=""/>
                   </div>
...
let vm = null;
import "../../utils/filter";
import cinemaTimeList from "./cinemaTimeList";
export default {
  components: {
    cinemaTimeList
  },
...
.cinema-swiper {
  ...
  overflow: hidden;
  .detail-bg {
    background: url(http://p0.meituan.net/148.208/movie/2721b55eac3ca107bad2af0e18592003431446.jpg)
      no-repeat;
  ...
  .swiper-container {
    ...
    .swiper-slide-active {
      ...
      .img-box {
        border: 0.053333rem solid white;
        position: relative;
        img {
          width: 2.133333rem !important;
